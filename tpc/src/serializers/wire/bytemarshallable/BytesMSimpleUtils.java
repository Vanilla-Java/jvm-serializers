...
public class BytesMSimpleUtils {
    ...
    public static final class WireSerializer extends Serializer<WMediaContent> {
        ...
        Bytes bytes = NativeBytesStore.nativeStoreWithFixedCapacity(1024).bytesForWrite();
        ...
        public WMediaContent deserialize(byte[] array) throws Exception {
            try {
                content.readMarshallable(Bytes.wrapForRead(array));
                return content;
            } catch (Throwable t) {
                t.printStackTrace();
                throw t;
        ...
        public byte[] serialize(WMediaContent content) throws Exception {
            ...
            content.writeMarshallable(bytes);
        ...
        public String getName() {
            return "chronicle-bytes-custom-" + count;
        }
    }
}
